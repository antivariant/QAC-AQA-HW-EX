...
var localPlus11Min = new Date(localDate.getTime()+11*60*1000)
console.log(localPlus11Min.toUTCString());//Tue, 10 Jan 2023 20:22:01 GMT
...
console.log(days);
// 5 - Сравнение дат
if (localDate1 > localDate) console.log("localDate1>localDate");
var utcDate1 = new Date("2023-01-11T22:11:01Z");
if (utcDate1 > utcDate) console.log("utcDate1>utcDate");
if (utcDate > localDate) console.log("utcDate>localDate");